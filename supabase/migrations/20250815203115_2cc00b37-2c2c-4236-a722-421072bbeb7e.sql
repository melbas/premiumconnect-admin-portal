-- Critical Security Fix: Secure remaining tables with RLS (Corrected)
...
-- 4. Create admin role checking function for access_profiles
...
-- Secure access_profiles table (WARNING - contains network config)
