-- Continue Phase 1: Fix remaining critical RLS issues
...
CREATE POLICY "chat_conversations_user_select"
ON public.chat_conversations FOR SELECT
TO authenticated
USING (auth.uid() = user_id);

CREATE POLICY "chat_conversations_user_insert"
ON public.chat_conversations FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "chat_conversations_user_update"
